...
class MatchScoreServiceTest {
    ...
    Map<UUID, MatchBoardDto> matchCollection = new HashMap<>();
    ...
    void changeScoreTest() {
        ...
        playerScoreDto1.setSets(1);
        playerScoreDto1.setGames(2);
        playerScoreDto1.setPoints(15);

        PlayerScoreDto playerScoreDto2 = new PlayerScoreDto();
        playerScoreDto2.setName("gey2");
        playerScoreDto2.setSets(1);
        playerScoreDto2.setGames(2);
        playerScoreDto2.setPoints(15);
        ...
        matchCollection.put(UUID.fromString(uuid), matchBoardDto);
    }
